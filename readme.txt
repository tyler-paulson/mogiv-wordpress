=== Plugin Name ===
Contributors: mogivdev
Tags: donate, ecommerce, churches, charity
...
The easiest way to embed your Mogiv giving form onto your WordPress site.
...
1. Upload the plugin files to the `/wp-content/plugins/mogiv-wordpress` directory, or install the plugin through the WordPress plugins screen directly.
1. Activate the plugin through the 'Plugins' screen in WordPress
1. Add the [mogiv] shortcode to a page or post, the only required parameter is an OID or a CID
